...
<div class="BackgroundSystem">
    ...
    <div class="SoundBar">
        ...
        <a href="home-enfermeiro.php"><img src="assets/img/paciente/icon-home.svg" class="IHome"></a>
        ...
        <main>
            <form action="" class="meu-perfil">
                ...
                <section style="display: flex; justify-content: center;padding-top:36px">
                    ...
                    <div id="box-inputs-forms">
                        <label class=" form-perfil">Digite CIP</label>
                ...
                <section style="display: flex; justify-content:left;padding-top:36px">
                    <div id="box-inputs-forms" style="padding-right: 40px;width:50%">
                        <label class="form-perfil">Digite seu CNS</label>
                        <input class="inputs-perfil" type="text" placeholder="XXX.XXX.XXX-XX" onkeypress="$(this).mask('000.000.000-00');">
                    </div>

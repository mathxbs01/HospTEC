        ...
        <main class="main-menus-home">
            <div style="background-color: #70CDFF;padding-left:35px;width:65%;padding-right:61px;border-radius: 0px 40px 0px 0px;padding-top:68px">
                ...
                <section class="menus-home">
                    ...
                    <a href="minhas-consultas-enfermeiro.php" class="box-menus-home">
                        <img src="assets/img/icon-atendimentos.svg">
                        <p class="txt-box-menus">Atendimentos Realizados</p>
                    </a>
                    <a href="perfil-enfermeiro.php" class="box-menus-home" style="margin-left: 52px;margin-right:52px">
                    ...
                    <a href="perfil-paciente" class="" style="background-color: transparent; padding: 30px; width: 100%; text-decoration: none !important;cursor:default">

...
<div class="BackgroundSystem">
    <div class="SoundBar">
        ...
        <a href=""> <img src="assets/img/recepcionista/icon-prontuario.svg" class="IMenu2"></a>
    ...
    <div class="topo">
        ...
        <main>
            <form action="" class="cad-consultas-paciente">
                ...
                <section style="display: flex;width:50%;padding-top:35px">
                    <div class="select-especialista" style="padding-right:82.5px ;">
                        <p class="txt-forms-bold">Nome do paciente</p>
                        <select name="select" class="select-cad">
                            <option value="1" selected></option>

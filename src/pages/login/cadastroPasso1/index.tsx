...
import { Enfermeiro, Paciente, Recepcionista, Medico } from '../../../components/TypeUser';

import { Container, Content, Header, Form, InputForm, LineForm, UserProfile, InputRadio, ButtonNext } from './style';
...
export function CadastroPasso1(){
    
    const [selectedRadioBtn, setSelectedRadioBtn] = React.useState('radio1');
    const [passwordCreate, setPassowordCreate] = React.useState('');
    const [passwordConfirmed, setPassowordConfirmed] = React.useState('');
    const [profile, setProfile] = React.useState("Paciente");
